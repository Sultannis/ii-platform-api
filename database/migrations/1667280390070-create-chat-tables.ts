...
export class createChatTables1667280390070 implements MigrationInterface {
  name = 'createChatTables1667280390070';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "users" ADD "chat_color" character varying(10) NOT NULL DEFAULT '#FAA774'`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "users" DROP COLUMN "chat_color"`);
